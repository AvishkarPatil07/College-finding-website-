...
//SQL qurry to get list of colleges
$sql = "SELECT * FROM `b.tech` WHERE college LIKE '%$search%' or info LIKE '%$search%'";

//execute query
$res = mysqli_query($conn, $sql);
//count rows
$count = mysqli_num_rows($res);
///check wheter college info avilable or not
if ($count > 0) {
    //college avilable
...
<?php
    ...
    //college not avilable
    echo "<div class='error'>college not found.</div>";
}
