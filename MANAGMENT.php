        ...
        <div class="container">
            <div class="card mb-3">
                <div class="card text-bg-dark">
                    <img src="img\MANAGMENT\<?php echo $img; ?>" class="card-img" id="top-img" alt="..." height="250px">
                    <div class="card-img-overlay">
                 
                        <img src="img\MANAGMENT\<?php echo $logo; ?>" id="logo" alt="...">
